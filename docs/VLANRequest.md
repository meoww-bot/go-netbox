...
`func (o *VLANRequest) GetQinqRole() VLANRequestQinqRole`

GetQinqRole returns the QinqRole field if non-nil, zero value otherwise.

### GetQinqRoleOk

`func (o *VLANRequest) GetQinqRoleOk() (*VLANRequestQinqRole, bool)`
...
`func (o *VLANRequest) SetQinqRole(v VLANRequestQinqRole)`
...
`func (o *VLANRequest) SetQinqRoleNil(b bool)`
