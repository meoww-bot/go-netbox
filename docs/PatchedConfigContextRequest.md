...
`func (o *PatchedConfigContextRequest) GetProfile() ConfigContextRequestProfile`

GetProfile returns the Profile field if non-nil, zero value otherwise.

### GetProfileOk

`func (o *PatchedConfigContextRequest) GetProfileOk() (*ConfigContextRequestProfile, bool)`
...
`func (o *PatchedConfigContextRequest) SetProfile(v ConfigContextRequestProfile)`
...
`func (o *PatchedConfigContextRequest) GetDataSource() ConfigContextProfileRequestDataSource`

GetDataSource returns the DataSource field if non-nil, zero value otherwise.

### GetDataSourceOk

`func (o *PatchedConfigContextRequest) GetDataSourceOk() (*ConfigContextProfileRequestDataSource, bool)`
...
`func (o *PatchedConfigContextRequest) SetDataSource(v ConfigContextProfileRequestDataSource)`
