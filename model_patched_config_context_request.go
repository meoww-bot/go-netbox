...
type PatchedConfigContextRequest struct {
	...
	Profile              NullableConfigContextRequestProfile    `json:"profile,omitempty"`
...
func (o *PatchedConfigContextRequest) GetProfile() ConfigContextRequestProfile {
	if o == nil || IsNil(o.Profile.Get()) {
		var ret ConfigContextRequestProfile
		return ret
	}
...
// SetProfile gets a reference to the given NullableConfigContextRequestProfile and assigns it to the Profile field.
