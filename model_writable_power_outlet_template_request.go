...
func (o *WritablePowerOutletTemplateRequest) GetColor() string {
...
// and a boolean to check if the value has been set.
func (o *WritablePowerOutletTemplateRequest) GetColorOk() (*string, bool) {
	if o == nil || IsNil(o.Color) {
		return nil, false
	}
	return o.Color, true
...
func (o *WritablePowerOutletTemplateRequest) SetColor(v string) {
	o.Color = &v
}
