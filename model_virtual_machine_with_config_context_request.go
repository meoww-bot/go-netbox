...
func (o *VirtualMachineWithConfigContextRequest) GetStartOnBoot() PatchedWritableVirtualMachineWithConfigContextRequestStartOnBoot {
...
// and a boolean to check if the value has been set.
func (o *VirtualMachineWithConfigContextRequest) GetStartOnBootOk() (*PatchedWritableVirtualMachineWithConfigContextRequestStartOnBoot, bool) {
	if o == nil || IsNil(o.StartOnBoot) {
		return nil, false
	}
...
func (o *VirtualMachineWithConfigContextRequest) SetStartOnBoot(v PatchedWritableVirtualMachineWithConfigContextRequestStartOnBoot) {
	o.StartOnBoot = &v
}
