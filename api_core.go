...
func (r ApiCoreDataSourcesListRequest) TagId(tagId []string) ApiCoreDataSourcesListRequest {
	r.tagId = &tagId
	return r
}

func (r ApiCoreDataSourcesListRequest) TagIdN(tagIdN []string) ApiCoreDataSourcesListRequest {
	r.tagIdN = &tagIdN
	return r
}
