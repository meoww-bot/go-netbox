...
type VLANRequest struct {
	...
	QinqRole             NullableVLANRequestQinqRole   `json:"qinq_role,omitempty"`
...
// SetQinqRole gets a reference to the given NullableVLANRequestQinqRole and assigns it to the QinqRole field.
